...
var InitialOutput = function (_React$Component) {
  ...
  _createClass(InitialOutput, [{
    ...
    value: function render() {
      return React.createElement("div", { className: "user-data" }, React.createElement("div", null, "user bmi #"), React.createElement("div", null, "user body fat %"), React.createElement("div", null, "user bmr #"), React.createElement("div", null, "user calories a day #"));
    }
  }]);
...
var History = function (_React$Component2) {
  ...
  _createClass(History, [{
    key: "render",
    value: function render() {
      return React.createElement("div", null, React.createElement("div", null, "This is a placeholder for the history section."), React.createElement("div", null, "CURRENT WEEK DISPLAY"), React.createElement("div", null, "DATE / CALORIES EATEN # / ITEMS (EX. STEAK - 679)"));
    }
  }]);
...
var UserGoals = function (_React$Component3) {
  ...
  _createClass(UserGoals, [{
    key: "render",
    value: function render() {
      return React.createElement("div", { className: "goals" }, React.createElement("div", { className: "current-goals" }, React.createElement("div", { className: "holder" }, React.createElement("div", { className: "goal" }, "Gain 10 pounds of muscle"), React.createElement("div", { className: "c-date" }, "6 / 24 / 17"), React.createElement("div", { className: "status" }, React.createElement("div", { className: "bar-outer" }, React.createElement("div", { className: "bar-inner bar-5" }))))), React.createElement("div", { className: "achieved-goals" }, React.createElement("div", { className: "holder" }, React.createElement("div", { className: "goal" }, "Lose 10 pounds"), React.createElement("div", { className: "c-date" }, "1 / 1 / 17"))));
    }
  }]);
...
var FoodModal = function (_React$Component5) {
  ...
  _createClass(FoodModal, [{
    ...
    value: function newCalorieRow(foodItemName) {
      ...
      React.createElement("tr", null, "//  ", React.createElement("td", { id: "contentItemName" }), "// ", React.createElement("td", { id: "contentBrandName" }, this.props.foodBrandName), "//  ", React.createElement("td", { id: "contentCalories" }, this.props.foodCalories), "//  ", React.createElement("td", { id: "contentServingSizeQ" }, this.props.foodServingSizeQ), "//  ", React.createElement("td", { id: "contentServingSizeU" }, this.props.foodServingSzieU), "//  ", React.createElement("td", null, React.createElement("i", { id: "deleteFood", "class": "fa fa-minus-circle", "aria-hidden": "true" })), "'");
    }
  }, {
    key: "handleClick",
    value: function handleClick(event) {
       ...
       */
      React.createElement("tr", null, React.createElement("td", { id: "contentItemName" }, " foodItemName"));
      /*
    ...
    value: function render() {
      ...
      var foodNodes = rowHits.map(function (food, index) {
        ...
        return React.createElement("tr", { key: index, className: "{index}" }, React.createElement("td", { id: "modalItemName" }, food.fields.item_name), React.createElement("td", { id: "modalBrandName" }, food.fields.brand_name), React.createElement("td", { id: "modalCalories" }, food.fields.nf_calories), React.createElement("td", { id: "modalServingSizeQ" }, food.fields.nf_serving_size_qty), React.createElement("td", { id: "modalServingSizeU" }, food.fields.nf_serving_size_unit), React.createElement("td", null, React.createElement("i", {
          id: "savefood",
          type: "button",
      ...
      return React.createElement("div", { className: "modal", style: modalStyle }, React.createElement("div", { className: "modal-dialog" }, React.createElement("div", { className: "modal-content" }, React.createElement("div", { className: "modal-header" }, React.createElement("button", {
        ...
        "data-dismiss": "modal",
        "aria-hidden": "true"
      }, "\xD7"), React.createElement("h4", { className: "modal-title" }, "Food Search")), React.createElement("div", { className: "modal-body" }, this.props.children, React.createElement("table", { className: "table table-striped table-hover " }, React.createElement("thead", null, React.createElement("tr", { className: "calorieTrackerRow" }, React.createElement("th", null, "Item Name"), React.createElement("th", null, "Brand Name"), React.createElement("th", null, "Calories"), React.createElement("th", null, "Serving Size Quantity"), React.createElement("th", null, "Serving Size Unit"))), React.createElement("tbody", { id: "foodSearchBody" }, foodNodes)), React.createElement("div", { className: "modal-footer" }, React.createElement("button", {
        onClick: this.props.onClose,
        type: "button",
...
var FoodSearch = function (_React$Component6) {
  ...
  _createClass(FoodSearch, [{
    ...
    key: "render",
    value: function render() {
      return React.createElement("div", null, React.createElement("label", { className: "control-label", htmlFor: "inputWarning" }, "Food Search", " "), " ", React.createElement("h2", null, "You can look up the calories for any food here."), React.createElement("br", null), React.createElement("div", { className: "search-group" }, React.createElement("input", {
        size: "100",
        className: "",
        name: "foodname",
...
var UpcSearch = function (_React$Component7) {
  ...
  _createClass(UpcSearch, [{
    ...
    key: "render",
    value: function render() {
      return React.createElement("div", null, React.createElement("label", { className: "control-label", htmlFor: "inputWarning" }, "UPC Search \xA0"), React.createElement("h2", null, "You can also search by UPC Code."), React.createElement("div", { className: "search-group" }, React.createElement("br", null), React.createElement("input", {
        size: "100",
        className: "",
  ...
  _createClass(Modal, [{
    ...
    value: function render() {
      ...
      return React.createElement("div", { className: "modal", style: modalStyle }, React.createElement("div", { className: "modal-dialog" }, React.createElement("div", { className: "modal-content" }, React.createElement("div", { className: "modal-header" }, React.createElement("button", {
        ...
        "data-dismiss": "modal",
        "aria-hidden": "true"
      }, "\xD7"), React.createElement("h4", { className: "modal-title" }, "Add Food to Calorie Tracker")), React.createElement("div", { className: "modal-body" }, this.props.children, React.createElement("form", { name: "modalForm" }, React.createElement("div", { className: "form-group" }, React.createElement("div", { className: "row" }, React.createElement("div", { className: "col-lg-2" }, React.createElement("label", { htmlFor: "inputItemName", className: "control-label" }, "Item Name")), React.createElement("div", { className: "col-lg-10" }, React.createElement("input", {
        type: "text",
      ...
      }))), React.createElement("br", null), React.createElement("div", { className: "row" }, React.createElement("div", { className: "col-lg-2" }, React.createElement("label", { htmlFor: "inputBrandName", className: "control-label" }, "Brand Name")), React.createElement("div", { className: "col-lg-10" }, React.createElement("input", {
        type: "text",
        className: "form-control",
        id: "inputBrandName",
      ...
      }))), React.createElement("br", null), React.createElement("div", { className: "row" }, React.createElement("div", { className: "col-lg-2" }, React.createElement("label", { htmlFor: "inputCalories", className: "control-label" }, "Calories")), React.createElement("div", { className: "col-lg-10" }, React.createElement("input", {
        type: "text",
        className: "form-control",
        id: "inputCalories",
      ...
      }))), React.createElement("br", null), React.createElement("div", { className: "row" }, React.createElement("div", { className: "col-lg-2" }, React.createElement("label", {
        htmlFor: "inputServingSizeQuantity",
        className: "control-label"
      }, "Serving Size Quantity")), React.createElement("div", { className: "col-lg-10" }, React.createElement("input", {
        type: "text",
        className: "form-control",
        ...
        className: "control-label"
      }, "Serving Size Unit")), React.createElement("div", { className: "col-lg-10" }, React.createElement("input", {
        type: "text",
        className: "form-control",
...
var CalorieTracker = function (_React$Component9) {
  ...
  _createClass(CalorieTracker, [{
    ...
    key: "render",
    value: function render() {
      return React.createElement("div", null, React.createElement("div", null, React.createElement("h2", null, "Keep track of your caloric intake here!"), React.createElement("div", { className: "calorieDiv" }, React.createElement("button", {
        type: "submit",
        onClick: this.toggleModal,
        href: "#",
        className: "btn btn-primary btn-sm"
      }, "add food"), React.createElement(Modal, { show: this.state.isOpen, onClose: this.toggleModal }), React.createElement("table", { className: "table table-striped table-hover " }, React.createElement("thead", null, React.createElement("tr", null, React.createElement("th", null, "Item Name"), React.createElement("th", null, "Brand Name"), React.createElement("th", null, "Calories"), React.createElement("th", null, "Serving Size Quantity"), React.createElement("th", null, "Serving Size Unit"))), React.createElement("tbody", { id: "calorieTrackerBody" })))), React.createElement("div", { className: "calorieDiv" }, React.createElement(FoodSearch, null)), React.createElement("div", { className: "calorieDiv" }, React.createElement(UpcSearch, null)));
    }
  }]);
